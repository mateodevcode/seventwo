            ...
            <div className="w-full flex flex-col items-end justify-center h-20 mt-5">
              <div>
                <p className="text-black text-xs p-1.5 bg-green-300 rounded-sm w-52 mr-2">
                  "¡Hola! 👋 <span className="font-semibold">Bienvenido a Seventwo.</span> 🚀 Creamos soluciones tecnológicas a la medida para tu negocio. Dinos qué necesitas y un asesor te atenderá de inmediato. 💬✨"
                </p>
              </div>
            </div>
